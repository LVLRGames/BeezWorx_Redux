...
## Weight per unit — affects movement speed when carrying
@export var unit_weight: float = 0.1
@export var is_liquid: bool = false
## Used by RecipeSystem and diplomacy matching
...
@export_group("Meta")
## For now just a quality grade: 0=crude, 1=basic, 2=refined, 3=royal
